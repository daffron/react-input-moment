          ...
          (0, _chunk2.default)(days, 7).map(function (row, week) {
            return _react2.default.createElement(
              ...
              row.map(function (day) {
                return _react2.default.createElement(Day, { key: day, day: day, currentDay: currentDay /*isReserved={() => this.isReserved(day, week, currentDay)}*/, week: week, onClick: function onClick() {
